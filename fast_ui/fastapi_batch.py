...
# ✨ Gradio UI
with gr.Blocks(theme=gr.themes.Soft(), css=".gr-button {background-color: #1f6feb !important; color: white;}") as batch_demo:
...
if __name__ == "__main__":
    batch_demo.launch(server_name="0.0.0.0", server_port=7860)
